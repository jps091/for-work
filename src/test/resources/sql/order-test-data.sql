...
-- 7 발송대기 5 취소
INSERT INTO `orders` (`canceled_at`, `registered_at`, `order_id`, `user_id`, `status`, `total_amount`, `request_id`)
...
-- 4 취소 6 부분구매확정
INSERT INTO `orders` (`confirmed_at`, `canceled_at`, `registered_at`, `order_id`, `user_id`, `status`, `total_amount`, `request_id`)
