...
-- 5 발송대기
INSERT INTO `orders` (`paid_at`, `order_id`, `user_id`, `status`, `total_amount`, `request_id`)
VALUES ('2024-08-14 18:18:39', '4', '4', 'WAIT', '70000', 'test-request-id-4');

-- 7 발송대기 5 취소
INSERT INTO `orders` (`paid_at`, `registered_at`, `order_id`, `user_id`, `status`, `total_amount`, `request_id`)
VALUES ('2024-09-11 09:23:39', '2024-09-11 09:18:39', '5', '1', 'PARTIAL_WAIT', '30000','test-request-id-5');

-- 전체 취소
INSERT INTO `orders` (`registered_at`, `order_id`, `user_id`, `status`, `total_amount`, `request_id`)
VALUES ('2024-09-05 00:18:39', '6', '1', 'CANCEL', '0','test-request-id-6');

-- 5,6,7 결제완료
INSERT INTO `orders` (`registered_at`, `paid_at`, `order_id`, `user_id`, `status`, `total_amount`, `request_id`)
VALUES ('2024-09-04 00:18:39', '2024-09-04 00:20:39', '7', '2', 'PAID', '165000','test-request-id-7');

-- 4 취소 6 부분구매확정
INSERT INTO `orders` (`paid_at`, `registered_at`,  `order_id`, `user_id`, `status`, `total_amount`, `request_id`)
VALUES ('2024-09-09 08:38:39', '2024-09-09 08:28:39',  '8', '3', 'PARTIAL_CONFIRM', '65000','test-request-id-8');